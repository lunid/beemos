    ...
    function webDescription(){
		...
		<!DOCTYPE html>
                ...
                <head>
                    ...
                    <title>WebService - '.$this->serviceName.'</title>
		<style type="text/css">
		    body    { font-family: Verdana, arial; color: #000000; background-color: #ffffff; margin: 0px 0px 0px 0px; }
		    p       { font-family: Verdana, arial; color: #000000; margin-top: 0px; margin-bottom: 12px; }
		...
		<body>
		<div class=content>
			<div class=title>WebService - '.$this->serviceName.'</div>
			<div class=nav>
				<p>Veja nosso <a href="'.$PHP_SELF.'?wsdl">WSDL</a> de serviços.
				<br />Clique nos métodos abaixo e veja seus detalhes.</p>
				<ul>';
				foreach($this->getOperations() as $op => $data){
				    $b .= "<li><a href='#' onclick=\"popout();popup('$op')\">$op</a></li>";
				    // create hidden div
				    $b .= "<div id='$op' class='hidden'>
				    <a href='#' onclick='popout()'><font color='#ffffff'>[X] Fechar</font></a><br><br>";
